...
time USE_EXPERIMENTAL_CUDNN_V8_API=0 USE_MPI=0 BUILD_CAFFE2=0 BUILD_CAFFE2_OPS=0 USE_NCCL=1 REL_WITH_DEB_INFO=1 DEBUG=1 USE_DISTRIBUTED=1 USE_MKLDNN=0 USE_CUDA=1 USE_FBGEMM=0 USE_NNPACK=0 USE_QNNPACK=0 python setup.py develop
